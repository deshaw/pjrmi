...
// Recreate with `cog.py -rc LongAxisRolledHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_axis_rolled_hypercube
//
//     cog.outl(primitive_axis_rolled_hypercube.generate(numpy.int64))
// ]]]
...
/**
 * A shifted cube which is a rolled view of another long-based
 * {@link Hypercube} across one or multiple axes.
 */
public class LongAxisRolledHypercube
    extends AxisRolledHypercube<Long>
    implements LongHypercube
{
     ...
     *                                  encountered.
     */
    public LongAxisRolledHypercube(final LongHypercube hypercube,
                                        final Roll<?>[] rolls)
               ...
               NullPointerException
    {
        ...
        return new LongAxisRolledHypercube(myHypercube, newRolls);
    }
...
// [[[end]]] (checksum: c9ede4a9e4ea96fcb857d961630d56d3)
