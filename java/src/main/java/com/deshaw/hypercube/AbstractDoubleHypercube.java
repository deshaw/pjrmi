...
//
//     cog.outl(abstract_primitive_hypercube.generate(numpy.float64))
// ]]]
import com.deshaw.hypercube.Dimension.Coordinate;
import com.deshaw.pjrmi.PJRmi.GenericReturnType;

/**
 * The base class for all double-based hypercubes.
 */
public abstract class AbstractDoubleHypercube
    extends AbstractHypercube<Double>
    implements DoubleHypercube
{
     ...
     * Constructor.
     */
    protected AbstractDoubleHypercube(final Dimension<?>[] dimensions)
        throws IllegalArgumentException,
               NullPointerException
    {
        super(dimensions, Double.class);
    ...
    public DoubleHypercube rollFlat(final long shift)
    {
        ...
        // Otherwise return a flat-rolled hypercube
            ...
            return new DoubleFlatRolledHypercube(this, shift);
        }
    }
     ...
     */
    @Override
    public double get(final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
     ...
     */
    @Override
    public void set(final double value, final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
        // Make sure that they match dimensionally
        if (coordinates == null) {
...
// [[[end]]] (checksum: 69622e9596e32177c5ba599f7a924583)
