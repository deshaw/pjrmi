...
//
//     cog.outl(primitive_nd_wrapping_hypercube.generate(4, numpy.float64))
// ]]]
import java.util.Map;

/**
 * A 4-dimensional hypercube which has {@code double} values
 * as its elements and is backed by a user-supplied array.
 */
public class Double4dWrappingHypercube
    extends AbstractDoubleHypercube
{
     ...
     * Constructor.
     */
    public Double4dWrappingHypercube(final double[][][][] array)
