...
// Recreate with `cog.py -rc Integer3dWrappingHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_nd_wrapping_hypercube
//
//     cog.outl(primitive_nd_wrapping_hypercube.generate(3, numpy.int32))
// ]]]
import java.util.Map;

/**
 * A 3-dimensional hypercube which has {@code int} values
 * as its elements and is backed by a user-supplied array.
 */
public class Integer3dWrappingHypercube
    extends AbstractIntegerHypercube
{
     ...
     * Constructor.
     */
    public Integer3dWrappingHypercube(final int[][][] array)
...
// [[[end]]] (checksum: 87773cf293045eb02646d95a145b570e)
