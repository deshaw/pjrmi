...
// Recreate with `cog -rc BooleanMaskedHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_masked_hypercube
//
//     cog.outl(primitive_masked_hypercube.generate(numpy.bool8))
// ]]]
...
/**
 * A sub-cube which is a masked view of another boolean-based
 * {@link Hypercube}.
 */
public class BooleanMaskedHypercube
    extends MaskedHypercube<Boolean>
    implements BooleanHypercube
{
     ...
     *                                  encountered.
     */
    public BooleanMaskedHypercube(final BooleanHypercube hypercube,
                                        final boolean[] mask)
