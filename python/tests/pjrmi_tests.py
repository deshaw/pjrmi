...
def get_pjrmi():
    ...
    additional_allowlisted_classes = ','.join([
        ...
        'com.deshaw.pjrmi.JniPJRmi$ArrayHandle',
        ...
        'com.deshaw.pjrmi.test.PJRmiTestHelpers$ObjectInterface',
        'com.deshaw.pjrmi.test.PJRmiTestHelpers$OneTwoThreeIterator',
        'com.deshaw.pjrmi.test.PJRmiTestHelpers$OneTwoThreeIterator$CustomNoSuchElementException',
