...
// Recreate with `cog.py -rc Long4dWrappingHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_nd_wrapping_hypercube
//
//     cog.outl(primitive_nd_wrapping_hypercube.generate(4, numpy.int64))
// ]]]
import java.util.Map;

/**
 * A 4-dimensional hypercube which has {@code long} values
 * as its elements and is backed by a user-supplied array.
 */
public class Long4dWrappingHypercube
    extends AbstractLongHypercube
{
     ...
     * Constructor.
     */
    public Long4dWrappingHypercube(final long[][][][] array)
...
// [[[end]]] (checksum: 56a6f0110ee84244445edd3e79963f1e)
