...
// Recreate with `cog.py -rc IntegerTransposedHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_transposed_hypercube
//
//     cog.outl(primitive_transposed_hypercube.generate(numpy.int32))
// ]]]
...
/**
 * A cube which is a transposed view of another int-based
 * {@link Hypercube}. This effectively means that its accessors are reversed
 * in order.
 */
public class IntegerTransposedHypercube
    extends TransposedHypercube<Integer>
    implements IntegerHypercube
{
     ...
     */
    private final IntegerHypercube myHypercube;
     ...
     */
    public IntegerTransposedHypercube(final IntegerHypercube hypercube)
...
// [[[end]]] (checksum: b874f0c16cd61299022223eed3b9515c)
