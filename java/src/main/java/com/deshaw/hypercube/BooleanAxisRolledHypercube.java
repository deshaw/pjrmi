...
//
//     cog.outl(primitive_axis_rolled_hypercube.generate(numpy.bool8))
// ]]]
...
/**
 * A shifted cube which is a rolled view of another boolean-based
 * {@link Hypercube} across one or multiple axes.
 */
public class BooleanAxisRolledHypercube
    extends AxisRolledHypercube<Boolean>
    implements BooleanHypercube
{
     ...
     *                                  encountered.
     */
    public BooleanAxisRolledHypercube(final BooleanHypercube hypercube,
                                        final Roll<?>[] rolls)
               ...
               NullPointerException
    {
        ...
        return new BooleanAxisRolledHypercube(myHypercube, newRolls);
    }
...
// [[[end]]] (checksum: 9b89be7463d6911245c86c1a50e7cf5a)
