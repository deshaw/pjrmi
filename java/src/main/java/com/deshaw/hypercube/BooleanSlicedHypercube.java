...
//
//     cog.outl(primitive_sliced_hypercube.generate(numpy.bool8))
// ]]]
...
/**
 * A sub-cube which is a sliced view of another boolean-based
 * {@link Hypercube}.
 */
public class BooleanSlicedHypercube
    extends SlicedHypercube<Boolean>
    implements BooleanHypercube
{
     ...
     *                                  encountered.
     */
    public BooleanSlicedHypercube(final BooleanHypercube hypercube,
...
// [[[end]]] (checksum: 5268d5c270249a0abfa1cfa4a1dc31ce)
