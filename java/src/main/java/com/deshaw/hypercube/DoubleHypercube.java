...
//
//     cog.outl(primitive_hypercube.generate(numpy.float64))
// ]]]
...
/**
 * A hypercube which holds {@code double} values.
 */
public interface DoubleHypercube
    extends Hypercube<Double>
{
     ...
     */
    public static final int itemsize = Double.BYTES;

    // -------------------------------------------------------------------------

    /**
     * Cast the given cube into a double cube, if possible, and give
     * it back. Otherwise copy the cube to a double, again if possible,
     ...
     *
     * @return The double cube, or {@code null} if the given cube was null.
     *
     * @throws UnsupportedOperationException if the cube cannot be copied into
     *                                       a double cube for some reason.
     */
    @SuppressWarnings("unchecked")
    public static DoubleHypercube toDoubleHypercube(final Hypercube<?> cube)
        throws UnsupportedOperationException
    {
        return (DoubleHypercube)(
            (cube == null || cube instanceof DoubleHypercube)
                ? cube
                : CubeMath.toDoubleHypercube(
                      cube,
                      new DoubleArrayHypercube(cube.getDimensions())
                  )
        );
    }
    ...
    /**
     * Cast the given cube into a double cube, if possible, and give
     * it back. Otherwise attempt to wrap the given cube as a double
     * one using the {@code BlahFromBlahHypercube} classes.
     *
     * @return The double cube, or {@code null} if the given cube
     *         was null or it could not be wrapped.
     */
    @SuppressWarnings("unchecked")
    public static DoubleHypercube asDoubleHypercube(final Hypercube<?> cube)
        throws UnsupportedOperationException
    {
        if (cube == null) {
            return null;
        ...
        if (cube instanceof IntegerHypercube) {
            return new DoubleFromIntegerHypercube((IntegerHypercube)cube);
        }
        if (cube instanceof LongHypercube) {
            return new DoubleFromLongHypercube((LongHypercube)cube);
        }
        if (cube instanceof FloatHypercube) {
            return new DoubleFromFloatHypercube((FloatHypercube)cube);
        }
        if (cube instanceof DoubleHypercube) {
            return (DoubleHypercube)cube;
        }
     ...
     * type-space.
     */
    public default DoubleHypercube array()
    {
        return this;
    }
    ...
    public default boolean contentEquals(final Hypercube<?> cube)
    {
        ...
        final DoubleHypercube that = asDoubleHypercube(cube);
        if (that == null) {
        ...
        for (long i=0; i < size; i++) {
            final double thisEl = this.weakGetAt(i);
            final double thatEl = that.weakGetAt(i);
            if (thisEl != thatEl &&
    ...
    @Override
    @GenericReturnType
    public default DoubleHypercube reshape(final long[] shape)
    {
    ...
    @Override
    @GenericReturnType
    public default DoubleHypercube reshape(final Dimension<?>[] dimensions)
        throws DimensionalityException,
               NullPointerException
    {
        // Checks
        ...
        return new DoubleWrappingHypercube(dimensions, this);
    }
    ...
    @Override
    @GenericReturnType
    public default DoubleHypercube transpose()
    {
        return new DoubleTransposedHypercube(this);
    }

    /**
     * Fill this hypercube with the given value.
     */
    public default void fill(final double v)
    {
    ...
    /**
     * Get a flattened view of this hypercube as a new {@code double[]}
        ...
        throws UnsupportedOperationException
    {
        ...
        final double[] destination = new double[(int)getSize()];
     ...
     *                                       an array.
     */
    public default void toFlattened(final double[] destination)
        throws UnsupportedOperationException
    {
        if (getSize() > Integer.MAX_VALUE) {
            throw new UnsupportedOperationException(
               ...
               UnsupportedOperationException
    {
        ...
        for (final long end = srcPos + length - left; i < end; /*inside*/) {
            bb.putDouble(weakGetAt(i++)); // 00
            bb.putDouble(weakGetAt(i++)); // 01
            bb.putDouble(weakGetAt(i++)); // 02
            bb.putDouble(weakGetAt(i++)); // 03
            bb.putDouble(weakGetAt(i++)); // 04
            bb.putDouble(weakGetAt(i++)); // 05
            bb.putDouble(weakGetAt(i++)); // 06
            bb.putDouble(weakGetAt(i++)); // 07
            bb.putDouble(weakGetAt(i++)); // 08
            bb.putDouble(weakGetAt(i++)); // 09
            bb.putDouble(weakGetAt(i++)); // 10
            bb.putDouble(weakGetAt(i++)); // 11
            bb.putDouble(weakGetAt(i++)); // 12
            bb.putDouble(weakGetAt(i++)); // 13
            bb.putDouble(weakGetAt(i++)); // 14
            bb.putDouble(weakGetAt(i++)); // 15
        ...
        switch (left) {
        case 0xf: bb.putDouble(weakGetAt(i++));
        case 0xe: bb.putDouble(weakGetAt(i++));
        case 0xd: bb.putDouble(weakGetAt(i++));
        case 0xc: bb.putDouble(weakGetAt(i++));
        case 0xb: bb.putDouble(weakGetAt(i++));
        case 0xa: bb.putDouble(weakGetAt(i++));
        case 0x9: bb.putDouble(weakGetAt(i++));
        case 0x8: bb.putDouble(weakGetAt(i++));
        case 0x7: bb.putDouble(weakGetAt(i++));
        case 0x6: bb.putDouble(weakGetAt(i++));
        case 0x5: bb.putDouble(weakGetAt(i++));
        case 0x4: bb.putDouble(weakGetAt(i++));
        case 0x3: bb.putDouble(weakGetAt(i++));
        case 0x2: bb.putDouble(weakGetAt(i++));
        case 0x1: bb.putDouble(weakGetAt(i++));
     ...
     */
    public default void fromFlattened(final double[] src,
                                      final int srcPos,
                                      final long dstPos,
                                      final int length)
        throws IllegalArgumentException,
     ...
     */
    public default void fromFlattened(final double[] array)
        throws IllegalArgumentException,
               NullPointerException
    {
        if (array == null) {
               ...
               IndexOutOfBoundsException
    {
        ...
        for (final long end = dstPos + length - left; i < end; /*inside*/) {
            ...
            weakSetAt(i++, bb.getDouble()); // 00
            weakSetAt(i++, bb.getDouble()); // 01
            weakSetAt(i++, bb.getDouble()); // 02
            weakSetAt(i++, bb.getDouble()); // 03
            weakSetAt(i++, bb.getDouble()); // 04
            weakSetAt(i++, bb.getDouble()); // 05
            weakSetAt(i++, bb.getDouble()); // 06
            weakSetAt(i++, bb.getDouble()); // 07
            weakSetAt(i++, bb.getDouble()); // 08
            weakSetAt(i++, bb.getDouble()); // 09
            weakSetAt(i++, bb.getDouble()); // 10
            weakSetAt(i++, bb.getDouble()); // 11
            weakSetAt(i++, bb.getDouble()); // 12
            weakSetAt(i++, bb.getDouble()); // 13
            weakSetAt(i++, bb.getDouble()); // 14
            weakSetAt(i++, bb.getDouble()); // 15
            bb.position(0);
        }
        if (left != 0) {
            is.read(buf, 0, left * Double.BYTES);
            switch (left) {
            case 0xf: weakSetAt(i++, bb.getDouble());
            case 0xe: weakSetAt(i++, bb.getDouble());
            case 0xd: weakSetAt(i++, bb.getDouble());
            case 0xc: weakSetAt(i++, bb.getDouble());
            case 0xb: weakSetAt(i++, bb.getDouble());
            case 0xa: weakSetAt(i++, bb.getDouble());
            case 0x9: weakSetAt(i++, bb.getDouble());
            case 0x8: weakSetAt(i++, bb.getDouble());
            case 0x7: weakSetAt(i++, bb.getDouble());
            case 0x6: weakSetAt(i++, bb.getDouble());
            case 0x5: weakSetAt(i++, bb.getDouble());
            case 0x4: weakSetAt(i++, bb.getDouble());
            case 0x3: weakSetAt(i++, bb.getDouble());
            case 0x2: weakSetAt(i++, bb.getDouble());
            case 0x1: weakSetAt(i++, bb.getDouble());
            }
        }
        postWrite();
    }
     ...
     *                                  some reason.
     */
    public default void copyFrom(final DoubleHypercube that)
    {
        if (that == null) {
     ...
     */
    public default double get(final long... indices)
     ...
     */
    public default void set(final double d, final long... indices)
        throws IndexOutOfBoundsException
    {
        weakSet(d, indices);
        postWrite();
     ...
     */
    public default double get(final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
     ...
     * @throws DimensionalityException  If the coordinates were bad.
     */
    public default void set(final double value,
     ...
     * @throws IndexOutOfBoundsException If the indices were bad.
     */
    public default double getAt(final long index)
        throws IndexOutOfBoundsException
    {
        preRead();
     ...
     * @throws IndexOutOfBoundsException If the indices were bad.
     */
    public default void setAt(final long index, final double value)
        throws IndexOutOfBoundsException
    {
    ...
    @GenericReturnType
    public default Hypercube<Double> mask(final boolean[] mask)
    {
        if (mask != null && mask.length == length(0)) {
            return new DoubleMaskedHypercube(this, mask);
        }
        else {
        ...
        throws IndexOutOfBoundsException
    {
        if (obj instanceof Number) {
            ...
            setObj(number.doubleValue(), indices);
        }
        else {
               ...
               IndexOutOfBoundsException
    {
        if (obj instanceof Number) {
            @SuppressWarnings("unchecked")
            final Number number = (Number)obj;
            setObjectAt(index, number.doubleValue());
        }
        else {
     ...
     *
     * @return the minimum value or {@code Double.NaN} if none was found.
     */
     ...
     * the {@code kwargs} of its {@code ndarray} equivalent.
     *
     * @return the maximum value or {@code Double.NaN} if none was found.
     */
    @Kwargs(value="axis,initial,where,keepdims,out")
    @GenericReturnType
     ...
     * the {@code kwargs} of its {@code ndarray} equivalent.
     *
     * @return the sum of all the values or {@code Double.NaN} if no elements
     *         were non-null.
     */
    @Kwargs(value="axis,initial,where,keepdims,out")
    @GenericReturnType
     ...
     * returned as a {@code double} and so may overflow, especially
     * for small types.
     *
     * @return the sum of all the values or {@code Double.NaN} if no elements
     *         were non-null.
     */
    public default double sum0d()
    {
        preRead();
        final long size = getSize();
        boolean any = false;
     ...
     *         non-null.
     */
    public default double nansum0d()
    {
        preRead();
        final long size = getSize();
        double sum = 0;
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __add__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __sub__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __mul__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __mod__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __pow__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __iadd__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __isub__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __imul__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __ipow__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __lt__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __le__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __eq__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __ne__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __ge__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __gt__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __truediv__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __floordiv__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __itruediv__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Double> __ifloordiv__(final double value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
                 ...
                 Array.getLength(object) == size)
        {
            ...
            for (long i = 0; i < size; i += length(getNDim()-1)) {
                ...
                try {
                    ...
                    fromFlattened((double[])array, 0, i, arrayLength);
                }
                catch (Exception e) {
