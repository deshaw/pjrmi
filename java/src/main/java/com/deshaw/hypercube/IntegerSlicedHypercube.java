...
// Recreate with `cog.py -rc IntegerSlicedHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_sliced_hypercube
//
//     cog.outl(primitive_sliced_hypercube.generate(numpy.int32))
// ]]]
...
/**
 * A sub-cube which is a sliced view of another int-based
 * {@link Hypercube}.
 */
public class IntegerSlicedHypercube
    extends SlicedHypercube<Integer>
    implements IntegerHypercube
{
     ...
     *                                  encountered.
     */
    public IntegerSlicedHypercube(final IntegerHypercube hypercube,
...
// [[[end]]] (checksum: dc7c8f4a69103e008211324f64879cf3)
