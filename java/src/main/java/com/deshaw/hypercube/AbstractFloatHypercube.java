...
//
//     cog.outl(abstract_primitive_hypercube.generate(numpy.float32))
// ]]]
import com.deshaw.hypercube.Dimension.Coordinate;
import com.deshaw.pjrmi.PJRmi.GenericReturnType;

/**
 * The base class for all float-based hypercubes.
 */
public abstract class AbstractFloatHypercube
    extends AbstractHypercube<Float>
    implements FloatHypercube
{
     ...
     * Constructor.
     */
    protected AbstractFloatHypercube(final Dimension<?>[] dimensions)
        throws IllegalArgumentException,
               NullPointerException
    {
        super(dimensions, Float.class);
    ...
    public FloatHypercube rollFlat(final long shift)
    {
        ...
        // Otherwise return a flat-rolled hypercube
            ...
            return new FloatFlatRolledHypercube(this, shift);
        }
    }
     ...
     */
    @Override
    public float get(final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
     ...
     */
    @Override
    public void set(final float value, final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
        // Make sure that they match dimensionally
        if (coordinates == null) {
...
// [[[end]]] (checksum: 08fec8f6ba1f52589654ce81380655f2)
