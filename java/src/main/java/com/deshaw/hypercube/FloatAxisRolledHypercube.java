...
//
//     cog.outl(primitive_axis_rolled_hypercube.generate(numpy.float32))
// ]]]
...
/**
 * A shifted cube which is a rolled view of another float-based
 * {@link Hypercube} across one or multiple axes.
 */
public class FloatAxisRolledHypercube
    extends AxisRolledHypercube<Float>
    implements FloatHypercube
{
     ...
     *                                  encountered.
     */
    public FloatAxisRolledHypercube(final FloatHypercube hypercube,
                                        final Roll<?>[] rolls)
               ...
               NullPointerException
    {
        ...
        return new FloatAxisRolledHypercube(myHypercube, newRolls);
    }
