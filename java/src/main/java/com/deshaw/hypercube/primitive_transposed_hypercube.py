...
/**
 * A cube which is a transposed view of another {primitive_type}-based
 * {{@link Hypercube}}. This effectively means that its accessors are reversed
 * in order.
 */
public class {object_type}TransposedHypercube
    extends TransposedHypercube<{object_type}>
...
{{
     ...
     */
    private final {object_type}Hypercube myHypercube;
     ...
     */
    public {object_type}TransposedHypercube(final {object_type}Hypercube hypercube)
