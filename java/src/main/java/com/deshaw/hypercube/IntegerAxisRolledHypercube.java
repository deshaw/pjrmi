...
// Recreate with `cog.py -rc IntegerAxisRolledHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_axis_rolled_hypercube
//
//     cog.outl(primitive_axis_rolled_hypercube.generate(numpy.int32))
// ]]]
...
/**
 * A shifted cube which is a rolled view of another int-based
 * {@link Hypercube} across one or multiple axes.
 */
public class IntegerAxisRolledHypercube
    extends AxisRolledHypercube<Integer>
    implements IntegerHypercube
{
     ...
     *                                  encountered.
     */
    public IntegerAxisRolledHypercube(final IntegerHypercube hypercube,
                                        final Roll<?>[] rolls)
               ...
               NullPointerException
    {
        ...
        return new IntegerAxisRolledHypercube(myHypercube, newRolls);
    }
...
// [[[end]]] (checksum: dc2359548bab46b941359fb9f9cf5ca3)
