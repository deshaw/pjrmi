...
// Recreate with `cog -rc FloatMaskedHypercube.java`
// [[[cog
//     import cog
//     import numpy
//     import primitive_masked_hypercube
//
//     cog.outl(primitive_masked_hypercube.generate(numpy.float32))
// ]]]
...
/**
 * A sub-cube which is a masked view of another float-based
 * {@link Hypercube}.
 */
public class FloatMaskedHypercube
    extends MaskedHypercube<Float>
    implements FloatHypercube
{
     ...
     *                                  encountered.
     */
    public FloatMaskedHypercube(final FloatHypercube hypercube,
                                        final boolean[] mask)
...
// [[[end]]] (checksum: 7c9e19927c53a4660606f70d98dce00f)
