...
//
//     cog.outl(primitive_transposed_hypercube.generate(numpy.float64))
// ]]]
...
/**
 * A cube which is a transposed view of another double-based
 * {@link Hypercube}. This effectively means that its accessors are reversed
 * in order.
 */
public class DoubleTransposedHypercube
    extends TransposedHypercube<Double>
    implements DoubleHypercube
{
     ...
     */
    private final DoubleHypercube myHypercube;
     ...
     */
    public DoubleTransposedHypercube(final DoubleHypercube hypercube)
...
// [[[end]]] (checksum: bc21764ce90ad0befb1d4b397e51873d)
