...
//
//     cog.outl(abstract_primitive_hypercube.generate(numpy.bool8))
// ]]]
import com.deshaw.hypercube.Dimension.Coordinate;
import com.deshaw.pjrmi.PJRmi.GenericReturnType;

/**
 * The base class for all boolean-based hypercubes.
 */
public abstract class AbstractBooleanHypercube
    extends AbstractHypercube<Boolean>
    implements BooleanHypercube
{
     ...
     * Constructor.
     */
    protected AbstractBooleanHypercube(final Dimension<?>[] dimensions)
        throws IllegalArgumentException,
               NullPointerException
    {
        super(dimensions, Boolean.class);
    ...
    public BooleanHypercube rollFlat(final long shift)
    {
        ...
        // Otherwise return a flat-rolled hypercube
            ...
            return new BooleanFlatRolledHypercube(this, shift);
        }
    }
     ...
     */
    @Override
    public boolean get(final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
     ...
     */
    @Override
    public void set(final boolean value, final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
        // Make sure that they match dimensionally
        if (coordinates == null) {
...
// [[[end]]] (checksum: 7db9f967e40269bb9b3648cf7b2c3d7c)
