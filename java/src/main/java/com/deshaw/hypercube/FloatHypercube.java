...
//
//     cog.outl(primitive_hypercube.generate(numpy.float32))
// ]]]
...
/**
 * A hypercube which holds {@code float} values.
 */
public interface FloatHypercube
    extends Hypercube<Float>
{
     ...
     */
    public static final int itemsize = Float.BYTES;

    // -------------------------------------------------------------------------

    /**
     * Cast the given cube into a float cube, if possible, and give
     * it back. Otherwise copy the cube to a float, again if possible,
     ...
     *
     * @return The float cube, or {@code null} if the given cube was null.
     *
     * @throws UnsupportedOperationException if the cube cannot be copied into
     *                                       a float cube for some reason.
     */
    @SuppressWarnings("unchecked")
    public static FloatHypercube toFloatHypercube(final Hypercube<?> cube)
        throws UnsupportedOperationException
    {
        return (FloatHypercube)(
            (cube == null || cube instanceof FloatHypercube)
                ? cube
                : CubeMath.toFloatHypercube(
                      cube,
                      new FloatArrayHypercube(cube.getDimensions())
                  )
        );
    }
    ...
    /**
     * Cast the given cube into a float cube, if possible, and give
     * it back. Otherwise attempt to wrap the given cube as a float
     * one using the {@code BlahFromBlahHypercube} classes.
     *
     * @return The float cube, or {@code null} if the given cube
     *         was null or it could not be wrapped.
     */
    @SuppressWarnings("unchecked")
    public static FloatHypercube asFloatHypercube(final Hypercube<?> cube)
        throws UnsupportedOperationException
    {
        if (cube == null) {
            return null;
        ...
        if (cube instanceof IntegerHypercube) {
            return new FloatFromIntegerHypercube((IntegerHypercube)cube);
        }
        if (cube instanceof LongHypercube) {
            return new FloatFromLongHypercube((LongHypercube)cube);
        }
        if (cube instanceof FloatHypercube) {
            return (FloatHypercube)cube;
        }
        if (cube instanceof DoubleHypercube) {
            return new FloatFromDoubleHypercube((DoubleHypercube)cube);
        }
     ...
     * type-space.
     */
    public default FloatHypercube array()
    {
        return this;
    }
    ...
    public default boolean contentEquals(final Hypercube<?> cube)
    {
        ...
        final FloatHypercube that = asFloatHypercube(cube);
        if (that == null) {
    ...
    @Override
    @GenericReturnType
    public default FloatHypercube reshape(final long[] shape)
    {
    ...
    @Override
    @GenericReturnType
    public default FloatHypercube reshape(final Dimension<?>[] dimensions)
        throws DimensionalityException,
               NullPointerException
    {
        // Checks
        ...
        return new FloatWrappingHypercube(dimensions, this);
    }
    ...
    @Override
    @GenericReturnType
    public default FloatHypercube transpose()
    {
        return new FloatTransposedHypercube(this);
    }
    ...
    /**
     * Get a flattened view of this hypercube as a new {@code float[]}
        ...
        throws UnsupportedOperationException
    {
        ...
        final float[] destination = new float[(int)getSize()];
     ...
     *                                       an array.
     */
    public default void toFlattened(final float[] destination)
        throws UnsupportedOperationException
    {
        if (getSize() > Integer.MAX_VALUE) {
            throw new UnsupportedOperationException(
               ...
               UnsupportedOperationException
    {
        ...
        final byte[] buf = new byte[16 * Float.BYTES];
     ...
     */
    public default void fromFlattened(final float[] src,
                                      final int srcPos,
                                      final long dstPos,
                                      final int length)
        throws IllegalArgumentException,
     ...
     */
    public default void fromFlattened(final float[] array)
        throws IllegalArgumentException,
               NullPointerException
    {
        if (array == null) {
     ...
     */
    public default float get(final Coordinate<?>... coordinates)
        throws DimensionalityException
    {
     ...
     * @throws DimensionalityException  If the coordinates were bad.
     */
    public default void set(final float value,
     ...
     */
    @Override
    public default void writeElement(final Float el,
                                     final DataOutputStream os,
                                     final ByteOrder bo)
        throws IOException
    {
    ...
    public default void writeElement(final Float el,
        ...
        throws BufferOverflowException,
               ReadOnlyBufferException
    {
        buf.putFloat(((el == null) ? Float.NaN : el));
    }
     ...
     */
    @Override
    public default Float readElement(final DataInputStream is,
                                             final ByteOrder bo)
        throws IOException
    {
     ...
     */
    @Override
    public default Float readElement(final ByteBuffer buf)
        throws BufferUnderflowException
    {
        return (buf.getFloat());
    }
    ...
    @GenericReturnType
    public default Hypercube<Float> mask(final boolean[] mask)
    {
        if (mask != null && mask.length == length(0)) {
            return new FloatMaskedHypercube(this, mask);
        }
        else {
        ...
        throws IndexOutOfBoundsException
    {
        if (obj instanceof Number) {
            ...
            setObj(number.floatValue(), indices);
        }
        else {
               ...
               IndexOutOfBoundsException
    {
        if (obj instanceof Number) {
            @SuppressWarnings("unchecked")
            final Number number = (Number)obj;
            setObjectAt(index, number.floatValue());
        }
        else {
     ...
     *
     * @return the minimum value or {@code Float.NaN} if none was found.
     */
     ...
     * the {@code kwargs} of its {@code ndarray} equivalent.
     *
     * @return the maximum value or {@code Float.NaN} if none was found.
     */
    @Kwargs(value="axis,initial,where,keepdims,out")
    @GenericReturnType
     ...
     * the {@code kwargs} of its {@code ndarray} equivalent.
     *
     * @return the sum of all the values or {@code Float.NaN} if no elements
     *         were non-null.
     */
    @Kwargs(value="axis,initial,where,keepdims,out")
    @GenericReturnType
     ...
     * returned as a {@code float} and so may overflow, especially
     * for small types.
     *
     * @return the sum of all the values or {@code Float.NaN} if no elements
     *         were non-null.
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __add__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __sub__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __mul__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __mod__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __pow__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __iadd__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __isub__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __imul__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __ipow__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __lt__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __le__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __eq__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __ne__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __ge__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Boolean> __gt__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __truediv__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __floordiv__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __itruediv__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
     ...
     */
    @GenericReturnType
    public default Hypercube<Float> __ifloordiv__(final float value)
        throws IllegalArgumentException,
               NullPointerException,
               UnsupportedOperationException
    {
                 ...
                 Array.getLength(object) == size)
        {
            ...
            for (long i = 0; i < size; i += length(getNDim()-1)) {
                ...
                try {
                    ...
                    fromFlattened((float[])array, 0, i, arrayLength);
                }
                catch (Exception e) {
